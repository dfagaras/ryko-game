(() => {
  "use strict";
  const M=window.RykoLevelModel, STORAGE_KEY="ryko-level-editor-v1", toolbox=document.getElementById("toolbox"), boardGrid=document.getElementById("boardGrid");
  ...
  document.querySelectorAll('[data-arm]').forEach(b=>b.onclick=()=>{armed=b.dataset.arm;render()});
